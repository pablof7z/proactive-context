...
agent_attribution: Prototype explicit/implicit tagging subagent
has_preregistered_criteria: true
has_method: true
has_structured_report: true
characterization: "Explicit/implicit tagging prototype experiment: tag-don't-drop works mechanically (deletion fires, tagging faithful), +37% claim density recovered, but 81% of claims tagged implicit causing severe signal dilution — provisional marker lands on settled facts not just proposals, promotion unreliable"
captured_at: 2026-06-17T12:44:22Z
---

Explicit/implicit tagging prototype experiment: tag-don't-drop works mechanically (deletion fires, tagging faithful), +37% claim density recovered, but 81% of claims tagged implicit causing severe signal dilution — provisional marker lands on settled facts not just proposals, promotion unreliable
