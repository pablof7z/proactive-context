...
- Be explicit about generated `docs/wiki` changes. If they matter, include them
  intentionally with the code or docs change they explain; otherwise call them
  out before handing off.
